...
(def screens-categories
  {:foundations [{:name :shadows :component shadows/view}]
   :animated-list [{:name      :animated-header-list
                    :component animated-header-list/mock-screen}]
   :avatar [{:name :group-avatar :component group-avatar/view}
            {:name :icon-avatar :component icon-avatar/view}
            {:name :user-avatar :component user-avatar/view}
            {:name :wallet-user-avatar :component wallet-user-avatar/view}
            {:name :channel-avatar :component channel-avatar/view}
            {:name :account-avatar :component account-avatar/view}]
   :banner [{:name :banner :component banner/view}]
   :buttons [{:name :button :component button/view}
             {:name :composer-button :component composer-button/view}
             {:name :dynamic-button :component dynamic-button/view}
             {:name :slide-button :component slide-button/view}
             {:name :predictive-keyboard :component predictive-keyboard/view}
             {:name :wallet-button :component wallet-button/view}
             {:name :wallet-ctas :component wallet-ctas/view}]
   :browser [{:name      :browser-input
              :component browser-input/preview-browser-input}]
   :calendar [{:name :calendar :component calendar/view}
              {:name :calendar-day :component calendar-day/view}
              {:name :calendar-year :component calendar-year/view}]
   :code [{:name :snippet :component code-snippet/view}]
   :colors [{:name :color-picker :component color-picker/view}]
   :community [{:name :community-card-view :component community-card/view}
               {:name      :community-membership-list-view
                :component community-membership-list-view/view}
               {:name :discover-card :component discover-card/view}
               {:name      :token-gating
   ...
   :counter [{:name :counter :component counter/view}
             {:name :step :component step/view}]
   :dividers [{:name :divider-label :component divider-label/view}
              {:name :divider-line :component divider-line/view}
              {:name :new-messages :component new-messages/view}
              {:name :divider-date :component divider-date/view}
              {:name :strength-divider :component strength-divider/view}]
   :drawers [{:name :action-drawers :component action-drawers/view}
             {:name      :documentation-drawer
              :component documentation-drawers/view}
             {:name :drawer-buttons :component drawer-buttons/view}
             {:name :drawer-top :component drawer-top/view}
             {:name :permission-drawers :component permission-drawers/view}]
   :dropdowns [{:name :dropdown :component dropdown/view}
               {:name :network-dropdown :component network-dropdown/view}]
   :empty-state [{:name :empty-state :component empty-state/view}]
   :gradient [{:name :gradient-cover :component gradient-cover/view}]
   ...
   :info [{:name :info-message :component info-message/view}
          {:name :information-box :component information-box/view}]
   :inputs [{:name :input :component input/view}
            {:name :address-input :component address-input/view}
            {:name :locked-input :component locked-input/view}
            {:name :profile-input :component profile-input/view}
            {:name      :recovery-phrase-input
             :component recovery-phrase-input/view}
            {:name :search-input :component search-input/view}
            {:name :title-input :component title-input/view}]
   :numbered-keyboard [{:name      :keyboard-key
                       ...
                       {:name :numbered-keyboard
                        :options {:insets {:top? true}}
                        :component
                        numbered-keyboard/preview-numbered-keyboard}]
   ...
   :list-items [{:name :account :component account-item/view}
                {:name :account-list-card :component account-list-card/view}
                {:name :channel :component channel/view}
                {:name      :community-list
                 :options   {:insets {:top? true}}
                 :component community-list/view}
                {:name :dapp :component dapp/preview}
                {:name :preview-lists :component preview-lists/view}
                {:name :token-value :component token-value/preview}
                {:name      :user-list
                 :options   {:topBar {:visible true}}
   ...
   :markdown [{:name :texts :component text/view}
              {:name :markdown-list :component markdown-list/view}]
   :messages [{:name :gap :component messages-gap/preview-messages-gap}
              {:name      :system-messages
               :component system-message/preview-system-message}
              {:name :author :component messages-author/view}]
   :navigation
   [{:name :bottom-nav-tab :component bottom-nav-tab/preview-bottom-nav-tab}
    {:name :top-nav :component top-nav/preview}
    {:name :page-nav :component page-nav/preview-page-nav}
    {:name      :floating-shell-button
     :component floating-shell-button/preview-floating-shell-button}]
   :notifications
   [{:name :activity-logs :component activity-logs/preview-activity-logs}
    {:name      :activity-logs-photos
     :component activity-logs-photos/preview-activity-logs-photos}
    {:name :toast :component toast/preview-toasts}
    {:name :notification :component notification/preview-notification}]
   :onboarding [{:name      :small-option-card
                 :component small-option-card/preview-small-option-card}]
   :password [{:name :tips :component tips/preview-tips}]
   :profile [{:name :profile-card :component profile-card/preview-profile-card}
             {:name :collectible :component collectible/preview-collectible}
             {:name      :select-profile
              :component select-profile/preview-select-profile}
             {:name :showcase-nav :component showcase-nav/view}]
   :reactions [{:name :react :component react/preview-react}]
   ...
   :selectors [{:name :disclaimer :component disclaimer/preview-disclaimer}
               {:name :filter :component filter/preview}
               {:name :selectors :component selectors/preview-selectors}
               {:name      :select-reactions
                :component selector-reactions/preview}]
   :settings [{:name :privacy-option :component privacy-option/preview-options}
              {:name :accounts :component accounts/preview-accounts}
              {:name :settings-item :component settings-item/preview}
              {:name      :reorder-item
               :component reorder-item/preview-reorder-item}
              {:name :category :component category/preview}
              {:name :data-item :component data-item/preview-data-item}]
   :share [{:name :qr-code :component qr-code/preview-qr-code}
           {:name      :share-qr-code
            :component share-qr-code/preview-share-qr-code}]
   :tabs [{:name :segmented :component segmented/preview-segmented}
          {:name :tabs :component tabs/preview-tabs}
          {:name :account-selector :component account-selector/preview-this}]
   :tags [{:name :context-tags :component context-tags/preview-context-tags}
          {:name :network-tags :component network-tags/preview}
          {:name :number-tag :component number-tag/preview}
          {:name      :permission-tag
           :component permission-tag/preview-permission-tag}
          {:name :status-tags :component status-tags/preview-status-tags}
          {:name :tags :component tags/preview-tags}
          {:name :token-tag :component token-tag/preview-token-tag}]
